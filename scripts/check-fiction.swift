...
@main enum FictionChecks {
    static func main() throws {
        ...
        precondition(found("the pier was cold; the Pier was colder; Pier Road") == ["the pier", "the Pier", "Pier"], "A multi-word name matches in any capitalization; its last word only when capitalized")
        ...
        precondition(found("the keep stood at Cold Keep, near the Keep") == ["Cold Keep", "Keep"], "File-name style places match too")
        precondition(found("Marrenton and Tamper and Valentine") == [], "Never part of a longer word")
        precondition(found("Bell rang. Law and order. The bell law.") == ["Bell", "Law", "bell law"], "World notes match by their words too")
