...
required = ['RELEASE_VERSION', 'RELEASE_BUILD', 'SPARKLE_PUBLIC_KEY', 'SIGNING_IDENTITY', 'CERTIFICATE', 'CERTIFICATE_PASSWORD', 'APPLE_ID', 'APPLE_TEAM_ID', 'APPLE_APP_PASSWORD', 'SPARKLE_PRIVATE_KEY', 'GITHUB_REPOSITORY']
...
if not os.environ['SIGNING_IDENTITY'].startswith('Developer ID Application:'): raise SystemExit('A Developer ID Application signing identity is required.')
